...
public function UpdateSubject($firstname, $lastname, $middlename, $dbirth, $gender, $province,
    $municipality, $barangay, $zipcode, $number, $institute, $course, $gname, $gnumber, $address, $id)
{
    ...
    $stmt->bind_param("sssssssssssssssi", $firstname, $lastname, $middlename, $dbirth, $gender, $province,
        $municipality, $barangay, $zipcode, $number, $institute, $course, $gname, $gnumber, $address, $id);
    return $stmt->execute();
}
